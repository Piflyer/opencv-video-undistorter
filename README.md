...
This project is based on this [OpenCV Calibration Guide.](https://docs.opencv.org/4.x/dc/dbb/tutorial_py_calibration.html) The project is also available on [Streamlit.](https://videoundistort.streamlit.app/).
