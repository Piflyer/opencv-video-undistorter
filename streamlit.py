...
if "runcount" not in st.session_state:
    ...
    with tab1:
        ...
        with st.container():
            ...
            """)
            size_sq = st.number_input("Size of square in mm", min_value=0, max_value=10000, key="size_sq")
    ...
    with tab2:
        ...
        with st.container():
            ...
            Set the number of square to calibrate the camera. It should be the number of square on each side of the checkerboard minus one.
            """)
            size_sq = st.number_input("Size of square in mm", min_value=0, max_value=10000)
